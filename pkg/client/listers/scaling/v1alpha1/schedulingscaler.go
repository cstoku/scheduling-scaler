...
type SchedulingScalerLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.SchedulingScaler, err error)
...
// List lists all SchedulingScalers in the indexer.
func (s *schedulingScalerLister) List(selector labels.Selector) (ret []*v1alpha1.SchedulingScaler, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.SchedulingScaler))
	})
	return ret, err
}
...
type SchedulingScalerNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.SchedulingScaler, error)
...
// List lists all SchedulingScalers in the indexer for a given namespace.
func (s schedulingScalerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.SchedulingScaler, err error) {
...
// Get retrieves the SchedulingScaler from the indexer for a given namespace and name.
func (s schedulingScalerNamespaceLister) Get(name string) (*v1alpha1.SchedulingScaler, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("schedulingscaler"), name)
	}
	return obj.(*v1alpha1.SchedulingScaler), nil
}
